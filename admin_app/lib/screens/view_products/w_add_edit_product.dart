...
class AddEditProduct extends ConsumerStatefulWidget {
  const AddEditProduct({required this.category, super.key, this.product});
          ...
          child: Column(
            ...
            children: [
              TextFormField(
                ...
                validator: GlobalValidators.validateIsNotEmpty,
              ...
              TextFormField(
                ...
                textInputAction: TextInputAction.next,
                validator: ProductValidators.validateOriginalPrice,
                onSaved: (newValue) =>
              ...
              TextFormField(
                ...
                textInputAction: TextInputAction.next,
                validator: ProductValidators.validateDiscountPercentage,
                onSaved: (newValue) => _productRequest =
