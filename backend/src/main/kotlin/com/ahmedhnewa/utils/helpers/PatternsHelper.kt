...
object PatternsHelper {
    ...
    val TOP_LEVEL_DOMAIN_STR: String = ("((aero|arpa|asia|a[cdefgilmnoqrstuwxz])"
...
//    val TOP_LEVEL_DOMAIN: Pattern = Pattern.compile(TOP_LEVEL_DOMAIN_STR)
    ...
    val IP_ADDRESS: Pattern = Pattern.compile(IP_ADDRESS_STRING)
    ...
    val WEB_URL: Pattern = Pattern.compile(
        "("
                + "("
                + "(?:" + PROTOCOL + "(?:" + USER_INFO + ")?" + ")?"
                + "DOM" + DOMAIN_NAME_STR + "AIN_NAME_STR"
                + "(?:" + PORT_NUMBER + ")?"
                + ")"
                + "(" + PATH_AND_QUERY + ")?"
                + WORD_BOUNDARY
    ...
    /**
     * Regular expression for valid email characters. Does not include some valid characters
     * defined in RFC5321: #&~!^`{}/=$*?|
     */
