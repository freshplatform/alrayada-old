...
class OrdersNotifier extends StateNotifier<OrdersNotifierState> {
  ...
  /// Create new order
  Future<void> checkout(SettingsState settingsState, WidgetRef ref,
      String orderNotes, PaymentMethod paymentMethod) async {
    ...
    try {
      ...
      if (settingsState.clearCartAfterCheckout) {
