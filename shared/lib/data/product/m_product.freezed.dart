...
class __$$_ProductRequestCopyWithImpl<$Res>
    extends _$ProductRequestCopyWithImpl<$Res, _$_ProductRequest>
...
class _$_ProductRequest implements _ProductRequest {
  ...
  factory _$_ProductRequest.fromJson(Map<String, dynamic> json) =>
      _$$_ProductRequestFromJson(json);
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$_ProductRequestToJson(
      this,
    );
  }
}
...
abstract class _ProductRequest implements ProductRequest {
  const factory _ProductRequest(
      ...
      final double originalPrice,
      final double discountPercentage,
      final List<String> categories}) = _$_ProductRequest;

  factory _ProductRequest.fromJson(Map<String, dynamic> json) =
      _$_ProductRequest.fromJson;
