...
import '../data/user/auth/m_auth_request_response.dart';
import '../data/user/m_user.dart';
...
class SharedUserNotifier extends StateNotifier<UserAuthenticatedResponse?> {
  ...
  Future<void> saveUser(
    ...
    final userContainerWithoutToken = userContainerWithToken.copyWith(token: '');
  ...
  UserAuthenticatedResponse getUserContainerFromJson(String json) =>
